...
#include "../../Src/Helpers/WisentHelpers/WisentHelpers.hpp"
...
namespace benchmark
{
    namespace utilities 
    {
        ...
        void parserWisentForString(WisentRootExpression* root); 
        
        void deserialiseWisentForString(WisentRootExpression* root); 
    }
}
