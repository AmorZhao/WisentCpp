...
// BOSS expression construction and evaluation helpers
...
struct BOSSExpression *newComplexBOSSExpression(
    struct BOSSSymbol *head, 
    size_t cardinality,
    struct BOSSExpression *arguments[]
);

/**
 *  bool = 0, char = 1, short = 2, int = 3, 
 *  long = 4, float = 5, double = 6, std::string = 7,
 *  Symbol = 8, ComplexExpression = 9
 */
...
// boss::expressions::Expression* createExpressionFromJson(
